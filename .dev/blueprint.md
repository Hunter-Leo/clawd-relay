...
| 008 | auto-hook-injection | 07 Done | ✅ done | 005 | P1 | S task: auto install/uninstall on Bridge lifecycle |
| 009 | web-client-ui | 07 Done | ✅ done | 004, 006 | P1 | Round 1: hook format/payload fix, WS url fix, DO state tracking |
